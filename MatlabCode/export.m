...
for i = 1:size(FRAME_ID, 2)
  outfilename = fullfile(outdir, sprintf("orbit-%08d-line-%08d-frame-%08d", ORBIT_NUMBER(i), OST_LINE_NUMBER(i), FRAME_ID(i)));
  f = fopen(outfilename, 'w');
  fprintf(f, '{ "latitude": %f, "longitude": %f, "alt": %f, "orbit": %d, "line": %d, "frame": %d, "iono": [', ...
